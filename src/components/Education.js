...
function Education(props) {
	return (
		<div className='main'>
			...
			<div className='project pad space'>
				<h4>
				...
				<p className='bullets'>
					...
					to store data for web-apps using Express with MongoDB & MongooseJS ODM
				</p>
			</div>
			<div className='project pad space'>
				<h4>
				...
				<p className='bullets'>▪️ Advanced French Language Certification</p>
			</div>
			<div className='project pad space'>
				<h4>
				...
				<p className='bullets'>
					▪️ Intermediate (L300) Japanese Language Certification
				</p>
			</div>
		</div>
	);
